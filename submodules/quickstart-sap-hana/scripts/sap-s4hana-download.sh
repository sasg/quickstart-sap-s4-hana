...
wget ${DOWNLOADLINK}submodules/quickstart-sap-hana/scripts/sap-s4hana-std-install-master.sh  --output-document=/root/install/sap-s4hana-std-install-master.sh
wget ${DOWNLOADLINK}submodules/quickstart-sap-hana/scripts/sap-s4hana-std-install.sh  --output-document=/root/install/sap-s4hana-std-install.sh
...
wget ${DOWNLOADLINK}submodules/quickstart-sap-hana/scripts/s4-std.params --output-document=/root/install/s4-std.params
...
wget ${DOWNLOADLINK}submodules/quickstart-sap-hana/scripts/sap-s4hana-std-install-validate-install.sh --output-document=/root/install/sap-s4hana-std-install-validate-install.sh
